        ...
        <>
            {
                ...
                transition duration-300 ${showTasks && 'opacity-100'}`}>
                            To Do List
                        </h1>

                        <div className={`grid grid-cols-3 gap-2.5 md:gap-5 opacity-0 transition-all duration-300 ease-in ${showTasks && 'opacity-100'}`}>
